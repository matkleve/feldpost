...
const CHECKS = [
  ...
  { name: "spec-coverage", cmd: "node", args: ["scripts/check-spec-coverage.mjs"] },
  {
    ...
    // @see docs/study/012-study-system-audit.md
  },
  {
