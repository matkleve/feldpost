...
1. Read `docs/design.md` for the design system (tokens, sizes, motion, principles)
2. Read `docs/glossary.md` for canonical element names
3. For each component in the target area:
