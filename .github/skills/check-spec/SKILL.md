...
<!-- canonical: .cursor/skills/check-spec/SKILL.md -->

# check-spec — pointer, not a skill

The instructions for this skill live in exactly one place:

**[`.cursor/skills/check-spec/SKILL.md`](../../../.cursor/skills/check-spec/SKILL.md)**
...
still finds `check-spec` by name and gets sent to the single source.
