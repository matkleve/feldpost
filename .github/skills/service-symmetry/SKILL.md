...
<!-- canonical: .cursor/skills/service-symmetry/SKILL.md -->

# service-symmetry — pointer, not a skill

The instructions for this skill live in exactly one place:

**[`.cursor/skills/service-symmetry/SKILL.md`](../../../.cursor/skills/service-symmetry/SKILL.md)**
...
still finds `service-symmetry` by name and gets sent to the single source.
