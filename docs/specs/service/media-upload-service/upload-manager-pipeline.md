...
| 8a1 | Job media type is document with low-confidence text address only | Treats job as unresolved location and routes to Clarifications                                                          | Low-confidence text address is not equivalent to parseable address                                      |
...
| 11b | GPS issue remains unresolved                                     | Stays in Clarifications lane for placement or later correction                                                          | Never exposes `upload anyway`                                                                           |
...
- [ ] Resolving one item from Clarifications does not auto-switch the selected lane/tab.
