...
- **Widget install (addable apps on the left nav):** [widget-install.md](widget-install.md)
- **Account context (personal or one organization):** [account-context.md](account-context.md)
