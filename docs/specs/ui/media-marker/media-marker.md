...
- [x] Marker geometry derives from **`--photo-marker-body-size`** — `_legacy-design-tokens.scss` defines **`calc(var(--spacing-6) * 1.25)`** (40px; **Phase 7 Batch 31**)
