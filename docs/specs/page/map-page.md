...
| 5   | Requests location pick from upload flow | Map enters crosshair mode for setting uploaded media location (placement banner)                                                 | `searchPlacementActive` signal                                                            |
...
| `searchPlacementActive` | `boolean`                                                                    | `false` | Crosshair cursor on map for upload location map-pick                         |
