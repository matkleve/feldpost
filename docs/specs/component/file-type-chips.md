...
| File                                                              | Purpose                                           |
| ----------------------------------------------------------------- | ------------------------------------------------- |
| `docs/element-specs/component/file-type-chips.md`                           | Contract for upload file-type chip behavior       |
...
- [x] Spec document created: `docs/element-specs/component/file-type-chips.md`
