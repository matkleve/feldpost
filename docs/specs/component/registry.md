...
| Slice | Body |
| --- | --- |
| Shared primitives, containers, dropdowns, grid, media, dialogs, toasts, account, view toggle | [`registry.primitives-and-layout.supplement.md`](registry.primitives-and-layout.supplement.md) |
