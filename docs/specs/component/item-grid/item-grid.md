...
| 12  | User hovers/focuses media item on desktop                                                  | Quiet actions fade in without layout shift; **tile slot shows gold hover emphasis** (including when selected); selection/map actions remain keyboard reachable                                                                                                           | hover/focus interaction           |
