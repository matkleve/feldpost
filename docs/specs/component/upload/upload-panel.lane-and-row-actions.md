...
flowchart LR
  ...
  B -->|issues address_deferred| I[Add GPS<br/>Add/Change address<br/>Retry<br/>Dismiss]
...
| `issues: address_deferred`                 | user deferred address during tray resolution                 | `Add GPS`, `Add/Change address`, `Retry`, `Dismiss`                                                                                                                                 | Same recovery surface as `missing_gps`; written by tray defer path                                                                                                             |
...
| `issues: address_deferred`                   | `Add GPS`, `Add/Change address`, `Retry`                                                                                                                                                              | `Dismiss`                                                                                                                             | danger text + danger icon |
...
| `add_gps_issue`           | `Add GPS`                                      | `edit`        | `issues`                                     | `missing_gps`, `address_deferred`, `document_unresolved`             | map-pick capability                  | placement workflow                       |
| `change_address_issue`    | `Add address` / `Change address`               | `edit`        | `issues`                                     | `missing_gps`, `address_deferred`, `document_unresolved`             | none                                 | address finder workflow                  |
...
| `retry`                   | `Retry`                                        | `primary`     | `issues`                                     | `missing_gps`, `address_deferred`, `conflict_review`, `upload_error` | retry preconditions met              | retry job                                |
