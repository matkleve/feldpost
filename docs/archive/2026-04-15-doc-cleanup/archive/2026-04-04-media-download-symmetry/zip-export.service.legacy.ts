...
export interface ZipExportContextLegacy {
...
/**
 * Legacy archive copy of ZipExportService.
 * Source of truth moved to adapters as part of MediaDownloadService Phase 2.
 */
@Injectable({ providedIn: 'root' })
export class ZipExportServiceLegacy {
  private readonly supabase = inject(SupabaseService);

  buildDefaultTitle(context: ZipExportContextLegacy): string {
