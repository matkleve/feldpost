...
- `docs/element-specs/component/item-grid/item-grid.md`
- `docs/element-specs/component/media/media-item.md`
...
3. **Rule conflict between global transition guidance and media spec timing**
   ...
   - Media spec and implementation use 80ms (`docs/element-specs/component/media/media-item.md`, `apps/web/src/app/features/media/media-item.component.scss:38`)
