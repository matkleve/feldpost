...
- **Next:** [Phase 7 — token migration](./phase-7-token-migration.md) **in progress** — continue **Batch 23+** deprecated **`--font-size-*`** alias burn-down in component SCSS / legacy token sheet (batch log in phase-7 doc). **§Risks:** Tailwind **`dark:`** ≠ system+OS dark until variant/ThemeService follow-up. Then Phases 8–11.
- **Last updated:** 2026-05-17 — Phase **6** closed; Phase **7** through latest font-size batches (see phase-7 doc); Phase 5 Group D; [tokens.md §3.1a — Phase 7 handoff](../design/tokens.md#phase-7-handoff--deferred-md3-rows-tweakcn).
...
| 7 — Token system unification | [phase-7-token-migration.md](./phase-7-token-migration.md) | **In progress (2026-05-17)** — **`--font-size-*`** legacy alias burn-down (**Batch 23+**; prior batches **1–5b**, **6**, **12**–**24** in phase-7 doc). Open: **13** (**§4 `hlm-toggle-group` / CVA**). **§Risks** (`dark:` vs semantic system dark). |
