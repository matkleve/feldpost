...
| 7 — Token system unification | [phase-7-token-migration.md](./phase-7-token-migration.md) | **In progress (2026-05-16)** — Batches 1–5b: spacing, bridge chains, fp-base removal, partial **`--fp-sys-color-*` → tweakcn**, system-dark mixin, **`--fp-ref-*`** `:root` definitions removed (hex in **`docs/design/tokens.md`** §3.1a). **`_legacy-design-tokens.scss`** shrink + Batch-3–deferred MD3 roles still open. |
