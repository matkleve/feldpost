...
- **Next:** [Phase 7 — token migration](./phase-7-token-migration.md) **in progress** — Batches **1–5b** landed (`--fp-ref-*` off `:root`; hex → **`docs/design/tokens.md`** §3.1a); shrink **`_legacy-design-tokens.scss`** + Batch-3–deferred **`--fp-sys-color-*`** MD3 rows; **§Risks:** Tailwind **`dark:`** ≠ system+OS dark until variant/ThemeService follow-up. Then 8–11.
- **Last updated:** 2026-05-16 (Phase 7 Batch 5b + §Risks; Phase 5 Group D / Phase 6 Gate B).
