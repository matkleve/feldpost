...
- **Next:** [Phase 7 — token migration](./phase-7-token-migration.md) **in progress** — Batches **1–5b**, **6** (`--fp-ref-*` off `:root`; hex → [tokens.md §3.1a — Phase 7 handoff](../design/tokens.md#phase-7-handoff--deferred-md3-rows-tweakcn)); Batch **6**: doc sync (`phase-0-discovery.md`, `panel-trigger.md` tweakcn-facing spacing/radius prose); shrink **`_legacy-design-tokens.scss`** + Batch-3–deferred **`--fp-sys-color-*`** MD3 rows; **§Risks:** Tailwind **`dark:`** ≠ system+OS dark until variant/ThemeService follow-up. Then 8–11.
- **Last updated:** 2026-05-17 (Phase 7 Batch 6 doc sync; Phase 7 Batches 1–5b; Phase 5 Group D / Phase 6 Gate B; [tokens.md §3.1a — Phase 7 handoff](../design/tokens.md#phase-7-handoff--deferred-md3-rows-tweakcn)).
...
| 7 — Token system unification | [phase-7-token-migration.md](./phase-7-token-migration.md) | **In progress (2026-05-17)** — Batches 1–5b + **6** (doc sync: `phase-0-discovery.md`, `panel-trigger.md`); spacing, bridge chains, fp-base removal, partial **`--fp-sys-color-*` → tweakcn**, system-dark mixin (4a), **`--fp-ref-*`** defs removed (hex [tokens.md §3.1a — Phase 7 handoff](../design/tokens.md#phase-7-handoff--deferred-md3-rows-tweakcn)). Open: bridge shrink, deferred MD3 **`--fp-sys-color-*`**, **§Risks** (`dark:` vs semantic system dark). |
