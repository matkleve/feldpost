...
**Retained (still consumed):** remaining **`--line-height-*`**, **`--radius-sm|md|lg|xl|full`**, **`--transition-interactive`** / **`--transition-fade-*`**, **`--container-radius-control|panel`**, **`--section-bg`**, **`--section-border`**, **`--section-text`**, **`--state-warning-bg`**, **`--state-danger-bg`**.
