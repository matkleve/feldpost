...
**Deferred:** **`--action-*`**, **`--menu-*`**, **`--interactive-focus-ring`** clusters — follow-up batches (**`--shadow-sm` / `--shadow-focus`** bridge — closed **Batch 45**; **`--field-*`** — closed **Batch 46**).
...
**Deferred:** **`--action-*`**, **`--menu-*`**, **`--interactive-focus-ring`** clusters — follow-up batches.
