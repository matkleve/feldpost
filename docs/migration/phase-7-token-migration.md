...
| No legacy color / fp-sys / fp-ref in app SCSS | `rg 'var\(--color-\|var\(--fp-sys-\|var\(--fp-ref-' apps/web/src/app --glob '*.scss'` | **0** matches (exit **1**) |
