...
**Deferred:** **`--action-*`**, **`--menu-*`** clusters — follow-up batches (**`--shadow-sm` / `--shadow-focus`** bridge — closed **Batch 45**; **`--field-*`** — closed **Batch 46**; **`--interactive-focus-ring`** — relocated **Batch 47**; **`--menu-*`** — closed **Batch 48**).
...
**Deferred:** **`--action-*`** cluster — follow-up batch (**`--menu-*`** — closed **Batch 48**).
...
**Deferred:** **`--action-*`** cluster — follow-up batch.
...
**Deferred:** none for this batch (**`--action-*`** remains on bridge — follow-up batch).
