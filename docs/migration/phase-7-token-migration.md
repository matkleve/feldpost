...
# Retired reference-palette definition gate (2026-05-16): see docs/archive/design-retired-md3-reference-tokens.md
...
**Interpretation:** No **application** SCSS/TS/HTML under `apps/web` references **`var(--fp-*)`**. Retired MD3 reference palette custom properties are no longer defined on `:root` (see **§ Batch 5b** and [`docs/archive/design-retired-md3-reference-tokens.md`](../archive/design-retired-md3-reference-tokens.md)). **`--fp-sys-color-*`** are no longer defined on `:root` (see **§ Batch 16**). Remaining non-color **`--fp-sys-*`** definitions were removed in **§ Batch 17**.
...
**Audit record (retired token literals, grep gates):** [`docs/archive/design-retired-md3-reference-tokens.md`](../archive/design-retired-md3-reference-tokens.md).
