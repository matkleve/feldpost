...
**Deferred:** Motion ladder removal (**many** `var(--motion-*)` call sites); **`--line-height-*`** / **`--font-weight-*`** (wide `var()` use); **`--content-clamp-*`**, remaining sidebar geometry; **`docs/design/token-layers.md`** Layer B bullets (**`--interactive-border-muted`** / **`--interactive-surface-hover`** — removed **Batch 36**; follow-up doc sync); **`docs/design/motion.md`** + component specs still citing removed **`--motion-duration-base`** / **`--motion-ease-standard`** until a doc-only pass.
...
**Deferred (file cap):** **`docs/design/token-layers.md`** Layer B bullets; **`docs/design/motion.md`**; component specs / **`feldpost-component` SKILL** still mentioning **`var(--motion-duration-base)`** / **`--motion-ease-standard`** — align to **`docs/design/tokens.md`** §3.6 in a follow-up.
