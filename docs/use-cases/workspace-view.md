...
**Related:** [map-shell IS-2](map-shell.md#is-2-open-workspace-pane-via-marker-click), [workspace-view-system (canonical)](../specs/service/workspace-view/workspace-view-system.md)
