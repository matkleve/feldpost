...
> **Related specs:** [projects-page](../element-specs/projects-page.md), [project-details-view](../element-specs/project-details-view.md), [image-detail-view](../element-specs/image-detail-view.md), [map-shell](../element-specs/map-shell.md)
