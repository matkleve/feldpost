...
- The **Sidebar** and **Search Bar** are positioned inside the map pane as floating component-level elements, not as separate layout columns. Their behavior and dimensions are defined in [docs/element-specs/component/sidebar.md](docs/element-specs/component/sidebar.md) and [docs/element-specs/search-bar/search-bar.md](docs/element-specs/search-bar/search-bar.md).
