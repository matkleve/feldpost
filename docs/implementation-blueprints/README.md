...
| 12  | [media-renderer-system.md](media-renderer-system.md)                   | [archived spec](../archive/element-specs-legacy/media-renderer-system.md) + [active replacement](../element-specs/media-download/media-download-service.md) | FileTypeRegistry, MediaOrchestrator (adaptive tier selection) |
