...
| 2   | [media-marker.md](media-marker.md)                                           | [element spec](../element-specs/media-marker/media-marker.md)                   | marker-factory, map-shell-helpers                             |
| 3   | [media-detail-view.md](media-detail-view.md)                                 | [element spec](../element-specs/media-detail/media-detail-view.md)              | ImageService (new), SupabaseService                           |
| 4   | [filter-panel.md](filter-panel.md)                                           | [element spec](../element-specs/component/item-grid-filter-operator.md)         | FilterService (new)                                           |
| 5   | [active-filter-chips.md](active-filter-chips.md)                             | [element spec](../element-specs/active-filter-chips.md)                         | FilterService                                                 |
| 6   | [workspace-pane.md](workspace-pane.md)                                       | [element spec](../element-specs/workspace/workspace-pane.md)                    | SelectionService (new)                                        |
...
| 9   | [search-bar.md](search-bar.md)                                               | [element spec](../element-specs/search-bar/search-bar.md)                       | SearchOrchestratorService                                     |
| 10  | [thumbnail-grid.md](thumbnail-grid.md)                                       | [element spec](../element-specs/thumbnail-grid.md)                              | GroupService, SelectionService                                |
| 11  | [media-multi-project-membership.md](media/media-multi-project-membership.md) | [multi-spec update](../element-specs/workspace/workspace-view-system.md)        | SupabaseService, WorkspaceViewService                         |
| 12  | [media-renderer-system.md](media-renderer-system.md)                         | [active replacement](../element-specs/media-download/media-download-service.md) | FileTypeRegistry, MediaOrchestrator (adaptive tier selection) |
