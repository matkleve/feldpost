...
| 3   | [media-detail-view.md](media-detail-view.md)                           | [element spec](../element-specs/media-detail-view.md)                                                                                                                                | ImageService (new), SupabaseService                           |
...
| 12  | [media-renderer-system.md](media-renderer-system.md)                   | [archived spec](../archive/element-specs-legacy/2026-04-02-item-grid-consolidation/media-renderer-system.md) + [active replacement](../element-specs/media-delivery-orchestrator.md) | FileTypeRegistry, MediaOrchestrator (adaptive tier selection) |
