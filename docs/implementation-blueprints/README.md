...
| 12  | [media-renderer-system.md](media-renderer-system.md)                   | [element spec](../element-specs/media-renderer-system.md)      | FileTypeRegistry, MediaOrchestrator (adaptive tier selection) |
