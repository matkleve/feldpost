# Workspace Actions Bar — Implementation Blueprint

> **Spec**: [element-specs/workspace/workspace-actions-bar.md](../element-specs/workspace/workspace-actions-bar.md)
...
### 1) Workspace Actions Bar Component
