...
| STUDY-009 | [Defensive security review (static) — September 2026](./009-defensive-security-review.md) | review | `partially-remediated` | F-01/F-02 remediated (do not redo — see ledger + TRAP-022); F-03…F-07 open. Static RLS/auth/storage/RPC review. |
