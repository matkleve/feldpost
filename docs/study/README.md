...
| STUDY-010 | [Shell grid layout — change plan (owner mock 2026-09-22)](./010-shell-grid-layout-change-plan.md) | proposal | `proposed` | Four-track shell (left rail · map · content panels · right rail); hover labels; settings/profile as panels not overlay. **Planning only — see GitHub issue.** |
