...
| **`docs/study/` itself** — writing, citing or gating a study | [STUDY-011](./011-study-system-audit.md), [`STUDY-FORMAT.md`](./STUDY-FORMAT.md) | What drifted, what is now enforced, and what a gate deliberately does not check. |
