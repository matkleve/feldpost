...
| STUDY-009 | [Defensive security review (static) — September 2026](./009-defensive-security-review.md) | review | `partially-remediated` | Static RLS/auth/storage/RPC review: chat private-message isolation regression (F-01) and cross-org `user_roles` admin SELECT (F-02) remediated; CI live validators, branding SVG, API-key listing remain open. |
