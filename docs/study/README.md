...
| --- | --- | --- |
| The **upload pipeline** (also in `AGENTS.md` § Document Authority) | [STUDY-005](./005-upload-pipeline-trace-findings.md), [STUDY-006](./006-upload-pipeline-correction-plan.md), [STUDY-016](./016-upload-flow-scale-and-folder-shapes.md) | What is broken, and the decisions + phase plan. STUDY-006 § Phase 5 is what is still open. STUDY-016 is the 2026-09-23 measurement at 1…100 000 files across folder shapes. |
