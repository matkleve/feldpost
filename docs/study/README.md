...
| **Widgets, role grants, GPS-and-media suite** | [STUDY-016](./016-widgets-page-flow.md), [STUDY-017](./017-role-widget-grants.md) | Both `proposed`. 016 is the directory flow. 017 is the role grant and the proposed suite. Neither is permission to build. |
