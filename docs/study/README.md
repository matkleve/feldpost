...
| STUDY-013 | [Widget modularity platform — change plan](./013-widget-modularity-platform-change-plan.md) | proposal | `proposed` | Installable widgets, catalog (+), bundles (Org+Colleagues). **Planning — [#258](https://github.com/matkleve/feldpost/issues/258).** |
