...
| **Addable apps (widgets)** ([#258](https://github.com/matkleve/feldpost/issues/258)) | [STUDY-016](./016-addable-apps-repo-shape.md) | Glossary definition and the repo shape. Still `proposed`. Do not add an install table from it. |
