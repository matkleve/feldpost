...
| STUDY-010 | [Defensive security review (static) — September 2026](./010-defensive-security-review.md) | review | `partially-remediated` | F-01…F-07 remediated in git + local-verify PASS; hosted `db push` still operator-side. Do not redo — TRAP-024. |
