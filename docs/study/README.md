...
| STUDY-018 | [Where pages and widgets sit on the rails](./018-rail-placement.md) | proposal | `proposed` | Owner leans that map, projects, and media can leave the rail. Workers and Organisation join the bottom-left container. A widget may also open a right-rail panel. Not permission to build. |
