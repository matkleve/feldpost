...
| **Authenticated shell / grid layout** ([#257](https://github.com/matkleve/feldpost/issues/257)) | [STUDY-014](./014-shell-grid-layout-change-plan.md) | Four-track grid, control-area containers vs content panels, migration phases. Still `proposed` — not permission to implement. |
...
| STUDY-014 | [Shell grid layout — change plan (authenticated app)](./014-shell-grid-layout-change-plan.md) | proposal | `proposed` | [#257](https://github.com/matkleve/feldpost/issues/257): four-track shell, backgroundless control areas with separate frosted containers (left top/bottom, right actions/history/help), content panel stack, map chrome moves, phased migration. Owner mock saved at `docs/design/mockups/grid-shell-owner-mock-2026-09-22.png`. |
