...
| STUDY-016 | [Widgets page — the flow, and what is not decided](./016-widgets-page-flow.md) | proposal | `proposed` | The `+` opens a directory, then one explanation page per widget. Install scope, catalog, and rail rules are open. Not permission to build. |
