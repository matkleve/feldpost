...
The paragraph in § 3 that says the cause was not recovered still stands as the state of the first run (`--detail=0`). This section adds the re-run. It does not delete that sentence. The ordered work is [STUDY-029](./029-upload-scale-action-plan.md).
