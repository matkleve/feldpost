...
| `apps/web/src/app/core/media/media-orchestrator.service.ts`                                             | `apps/web/src/app/core/media-download/adapters/tier-resolver.adapter.ts` + `docs/archive/code-legacy/2026-04-04-media-download-symmetry/media-orchestrator.service.legacy.ts`                                                                       | ARCHIVED         | `MediaOrchestratorService` remains as thin deprecated compatibility wrapper; full legacy implementation moved to archive |
...
| `apps/web/src/app/core/zip-export.service.ts`                                                           | `apps/web/src/app/core/media-download/adapters/edge-export-orchestrator.adapter.ts` (client) + `docs/archive/code-legacy/2026-04-04-media-download-symmetry/zip-export.service.legacy.ts` + `supabase/functions/media-export-zip/index.ts` (server) | ARCHIVED         | `ZipExportService` remains as thin deprecated compatibility wrapper; full legacy implementation moved to archive         |
| `apps/web/src/app/core/zip-export.helpers.ts`                                                           | `apps/web/src/app/core/media-download/media-download.helpers.ts` (shared module helpers)                                                                                                                                                            | In Progress      | Helper ownership shifts from UI-local ZIP builder to edge export context                                                 |
