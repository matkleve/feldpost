...
| Missing user-facing explanation of why options appear/disappear in row dropdown                                    | `docs/element-specs/upload-panel.md`, `apps/web/src/app/features/upload/upload-panel-item.component.ts`                                                                                                                      | Add explicit visibility/rationale matrix per lane/issue/state to make option gating transparent and testable.                                              | P1       |
...
| Segmented switch style mismatch (Queue/Uploaded should be icon-only square controls, Issues wider with icon+label) | `apps/web/src/app/features/upload/upload-panel.component.html`, `apps/web/src/app/shared/segmented-switch/segmented-switch.component.scss`, `apps/web/src/app/features/upload/upload-panel.component.scss`                   | Lock segmented style contract: Queue/Uploaded remain icon-only with square footprint; Issues remains wider with icon+label.                                | P1       |
