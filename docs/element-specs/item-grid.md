...
| 3   | Domain item enters loading state                                                       | Base ItemComponent renders pulse placeholder (spinner forbidden); domain child spec defines loading icon semantics                  | `loading=true`                    |
