...
describe('SearchBarComponent', () => {
    ...
    it('shows the clear button after a committed candidate and clears state when clicked', () => {
        ...
        const clearButton = fixture.nativeElement.querySelector('.search-bar__clear') as HTMLButtonElement;
    ...
    it('shows the empty state and emits drop pin when requested', async () => {
        ...
        const dropPinButton = fixture.nativeElement.querySelector('.search-bar__ghost-action') as HTMLButtonElement;
        dropPinButton.click();
