...
export const inputVariants = cva(
  'block h-10 w-full min-w-0 max-w-full rounded-md border border-input bg-background px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:shadow-[var(--interactive-focus-ring)] disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      error: {
