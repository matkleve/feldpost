...
export const tabsTriggerVariants = cva(
  'inline-flex cursor-pointer items-center justify-center whitespace-nowrap text-sm font-medium transition-[color,background-color,box-shadow] focus-visible:outline-none focus-visible:shadow-[var(--interactive-focus-ring)] disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
        ...
        line:
          `relative rounded-none border border-transparent px-4 pb-3 pt-2 text-muted-foreground ${tabQuietEmphasis} data-[state=active]:bg-transparent data-[state=active]:text-[var(--interaction-selected-ink)] data-[state=active]:not-focus-visible:shadow-none ${tabSelectedHover} after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 after:bg-[var(--interaction-selected-ink)] after:opacity-0 after:transition-opacity data-[state=active]:after:opacity-100`,
      },
    },
    defaultVariants: {
      variant: 'default',
...
export const tabsContentVariants = cva(
  'mt-2 focus-visible:outline-none focus-visible:shadow-[var(--interactive-focus-ring)]',
);
