-- PL/pgSQL OUT column share_set_id from RETURNS TABLE shadows ON CONFLICT (share_set_id, …).
-- @see supabase/migrations/20260318151000_fix_share_set_sha256_ambiguous_column.sql
