-- =============================================================================
-- Runtime fix: use canonical media_type = 'photo' in map + location RPCs
-- =============================================================================
-- Background:
-- Upload pipeline stores photos as media_type='photo'. Several RPCs still filtered
-- on media_type='image', which excluded newly uploaded photos from map markers
